...
function SpinnerWhole(props) {
    ...
    return (
        <div className={'w-full float-left bg-white  text-black dark:text-white h-[100vh] items-center justify-center content-center flex ' + (session ? 'dark:bg-gray-900' : 'bg-black')}>
