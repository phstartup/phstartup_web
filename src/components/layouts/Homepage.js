...
const protectedPages = [
    ...
    '/products',
    '/products/create',
    '/products/create/templates',
    '/products/edit',
    '/products/edit/templates',
    '/ads',
    '/ads/create',
    '/ads/edit',
    '/ads/results',
    ...
    return (
        <div className='w-full float-left'>
            <div className='float-left w-full min-h-full bg-white dark:bg-gray-900 text-black dark:text-white'>
                ...
                {
                    (!loading && !session) && (
                        <div className='w-full float-left bg-white dark:bg-gray-900 text-black dark:text-white min-h-[100px]'>
                            <NotLoggedInHeader />
                            <div className='w-full float-left'>
                                {
                                    children
                ...
                {
                    loading && (
                        <div className='w-full float-left bg-white dark:bg-gray-900 text-black dark:text-white h-[100vh] items-center justify-center content-center flex'>
                            <svg className="w-8 h-8 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-green-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
